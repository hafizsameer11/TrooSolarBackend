    ...
    public function update(Request $request)
    {
        try {
            $request->validate([
                ...
                'credit_check_residential_manual_upload_intro' => 'nullable|string|max:2000',
                'credit_check_residential_manual_docs_title' => 'nullable|string|max:255',
                'credit_check_residential_manual_bank_label' => 'nullable|string|max:255',
                'credit_check_residential_manual_bank_hint' => 'nullable|string|max:500',
                'credit_check_residential_manual_selfie_label' => 'nullable|string|max:255',
                'credit_check_residential_manual_selfie_button' => 'nullable|string|max:255',
                'credit_check_residential_manual_selfie_hint' => 'nullable|string|max:500',
                'credit_check_residential_manual_submit_label' => 'nullable|string|max:255',
                'credit_check_sme_manual_upload_intro' => 'nullable|string|max:2000',
                'credit_check_sme_manual_docs_title' => 'nullable|string|max:255',
                'credit_check_sme_manual_bank_label' => 'nullable|string|max:255',
                'credit_check_sme_manual_bank_hint' => 'nullable|string|max:500',
                'credit_check_sme_manual_selfie_label' => 'nullable|string|max:255',
                'credit_check_sme_manual_selfie_button' => 'nullable|string|max:255',
                'credit_check_sme_manual_selfie_hint' => 'nullable|string|max:500',
